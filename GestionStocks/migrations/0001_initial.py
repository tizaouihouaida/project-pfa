    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_notification', models.CharField(choices=[('peremption', 'Péremption'), ('stock', 'Stock'), ('stock_epuise', 'Stock épuisé'), ('alerte_stock', 'Alerte stock')], default='stock', max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Medicament',
